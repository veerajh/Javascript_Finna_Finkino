...
function addGenresToMenu(genreArray){
  ...
  function onGetMovieSchedule(xml) {
    ...
    //yksttäinen alkio (esim. komedia) voi
    //esiintyä joukossa vain kerran, eli voit lisätä saman alkion
    //useita kertoja, mutta se esiintyy joukossa vain kerran
